...
class ChangeEvaluationsIndexToUnique < ActiveRecord::Migration
  def self.up
    ...
    add_index :rs_evaluations, [:reputation_name, varchar(50), :source_id, varchar(25), :source_type,varchar(25), :target_id,varchar(25), :target_type, varchar(25)], :name => "index_rs_evaluations_on_reputation_name_and_source_and_target", :unique => true
  end
